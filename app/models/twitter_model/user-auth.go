...
func GetAuthUserClient() *twitter.Client {
	flags := flag.NewFlagSet("user-auth", flag.ExitOnError)
	consumerKey := flags.String("consumer-key", "uj61G88S2dYz68nwgEJemYWva", "Twitter Consumer Key")
	consumerSecret := flags.String("consumer-secret", "x3gjl4GCgaAbyxdpQtyy76HesOaqApykYTsIbPwqZcw3EOU6kr", "Twitter Consumer Secret")
	accessToken := flags.String("access-token", "1332643504799899654-4lbC1Cvm0jmKHoKTGNOqvigL45MNCS", "Twitter Access Token")
	accessSecret := flags.String("access-secret", "lRkpxpFDNaEd7sHl6IMleVueTmKr1IcnYcbbyZ1xXc7PQ", "Twitter Access Secret")
