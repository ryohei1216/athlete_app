...
func GetAuthAppClient() *twitter.Client {
	flags := struct {
		consumerKey    string
	...
	flag.StringVar(&flags.consumerKey, "consumer-key", "uj61G88S2dYz68nwgEJemYWva", "Twitter Consumer Key")
	flag.StringVar(&flags.consumerSecret, "consumer-secret", "x3gjl4GCgaAbyxdpQtyy76HesOaqApykYTsIbPwqZcw3EOU6kr", "Twitter Consumer Secret")
	flag.Parse()
